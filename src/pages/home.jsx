        ...
        <div>
            ...
            <div className="hero min-h-screen" style={{backgroundImage: `url(${Hotel1})`}}>
                ...
                <div className="hero-content text-center text-neutral-content">
                    <div className='p-3 bg-base-100 rounded-xl flex flex-col sm:flex-row items-center'>
                        ...
                        <div className='form-controll'>
                            <Link className='btn btn-primary w-36'>Search</Link>
                        </div>
                    </div>
            ...
            <div className='p-4'>
                ...
                <div className='flex flex-row gap-4 justify-evenly flex-wrap'>
                    <RoomCard img={Superior} title="Superior" message="Unveiling the latest collection of rooms and suites. Experience elevated luxury living and unparalleled hospitality, unlike anything you’ve known before."/>
                    <RoomCard img={Superior} title="Superior" message="Unveiling the latest collection of rooms and suites. Experience elevated luxury living and unparalleled hospitality, unlike anything you’ve known before."/>
                    <RoomCard img={Superior} title="Superior" message="Unveiling the latest collection of rooms and suites. Experience elevated luxury living and unparalleled hospitality, unlike anything you’ve known before."/>
                    <RoomCard img={Superior} title="Superior" message="Unveiling the latest collection of rooms and suites. Experience elevated luxury living and unparalleled hospitality, unlike anything you’ve known before."/>
            ...
            <footer className="footer footer-center p-10 bg-primary text-primary-content">
                <aside>
                    ...
                    Grand Atma Hotel Ltd. <br/>Providing the best hotel since 1992
                    </p> 
