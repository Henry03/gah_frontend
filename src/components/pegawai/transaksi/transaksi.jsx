...
import ReservasiDetailModal from "./transaksiDetailModal";
...
function Transaksi () {
    ...
    return (
        <>
                    ...
                    <div className="rounded-xl ">
                        <div className="flex items-center">
                            ...
                            <select className="select select-bordered max-w-xs ms-2" value={filter} onChange={(e)=>setFilter(e.target.value)}>
                                ...
                                <option value='nama'>Customer Name</option>
            ...
            <LoadingModal />
            <Error id="error_modal" title={"Error Happened"} message={"Something went wrong, please refresh the page. If the problem doesn't resolve please contact us on support@gah.com"} button={"Refresh Page"} onClick={()=>window.location.reload()}/>
            <TransaksiDetailModal id={idReservasi} setId={setId} fetchData={fetchData}/>
        </>
